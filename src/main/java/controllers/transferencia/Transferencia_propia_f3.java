...
public class Transferencia_propia_f3 implements ITestListener{
    ...
    public static void main(String[] args) {
        ...
        classes.add(new XmlClass("tests.transferencia.Transferencia_propia_test_f3"));
        test.setXmlClasses(classes);
        testng.setXmlSuites(List.of(suite));
        // Agregar el listener
        testng.addListener(new Transferencia_propia_f3());
